        ...
        <div className="space-y-2">
          {cases.map((c) => (
            <button
              ...
              className="w-full rounded-md border border-line px-4 py-2.5 text-left transition-colors hover:bg-raised"
            >
              <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
                <span className="flex items-baseline gap-2.5">
                  ...
                  <span className="text-[13.5px] text-ink">{c.case.Name.replace(/_/g, " ")}</span>
                </span>
                <span className="tnum text-[12px] text-ink-faint">
              ...
              <p className="mt-1 text-[13px] leading-snug text-ink-faint">{c.case.Scenario}</p>
